...
if __name__=='__main__':
        while True:
            ...
            if data1 == 0:
                ...
                txspeech("please enter the following details")
                pw.sendwhatmsg(input("Enter phone_number :"),input("Enter message :"),int(input("Enter hours :")),int(input("Enter min :")),15,True,4)
                txspeech("successfully delivered")
                ...
                while True:
                    ...
                    txspeech(abgh)
                    time.sleep(2)
                    txspeech("Exiting from search mode")
                    txspeech("kindly wait")
                    txspeech("successfully exited from search mode")
                    break
            elif "reminder" in data1:
                txspeech("sure, setting reminder for you")
                txspeech("please tell, what i will remind you")
                while True:
                    notification.notify(
                        message=sptext(),
                        timeout=6)
                    txspeech("done, i will remind you")
                    time.sleep(10)
                    break
                ...
                translation1 = translator1.translate(input("Enter the text in German to translate : "))
                print(translation1)
